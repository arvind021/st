...
# ── Create indexes on startup (call once from main.py) ────
async def create_indexes():
    await users_col.create_index("user_id", unique=True)
    await banned_col.create_index("user_id", unique=True)
    await batches_col.create_index("batch_id", unique=True)
    await special_links_col.create_index("link_id", unique=True)
    await universal_links_col.create_index("link_id", unique=True)
    await user_settings_col.create_index("user_id", unique=True)
